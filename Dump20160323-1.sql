...
CREATE TABLE `burger_bread` (
  ...
  `breadName` varchar(45) NOT NULL DEFAULT 'breadName',
...
CREATE TABLE `burger_flaver` (
  ...
  `flaverPrice6inch` int(11) NOT NULL DEFAULT '999',
...
CREATE TABLE `burger_veg` (
  ...
  `vegName` varchar(45) NOT NULL DEFAULT 'vegName',
  `url` varchar(100) DEFAULT NULL,
  `describ` varchar(100) DEFAULT NULL,
...
INSERT INTO `customers` VALUES ('A123456770','陳小華','123456','Aaa@uuu.com.tw','F','2016-02-16',NULL,NULL,NULL,0,0),('A123456789','王小明','123456','uuu@uuu.com.tw','M','2016-02-16','02123456789','台中市','Customer',0,0),('A159350730','å¨å¨','123456','dlin@abb.com','M',NULL,NULL,NULL,NULL,0,0),('G126200776','陳忠茂','123456789','dasi483@yahoo.com.tw','M','2016-02-17','03-9781027','宜蘭縣頭城鎮濱海路五段483號','VIP',0,0),('L223911848','WWW','123456','akazuma82@gmail.com','F',NULL,'0',NULL,NULL,0,0);
...
CREATE TABLE `products` (
  ...
  `price` int(10) NOT NULL DEFAULT '999',
  `url` varchar(500) DEFAULT NULL,
  `priceLarge` int(10) DEFAULT '-1',
  `priceMiddle` int(10) DEFAULT '-1',
  `priceSmall` int(10) DEFAULT '-1',
  `describ` varchar(500) DEFAULT NULL,
  `addDate` date NOT NULL,
  `status` int(10) NOT NULL DEFAULT '0',
  `size` varchar(50) DEFAULT 'null',
  `catagory` varchar(8) DEFAULT NULL,
...
-- Dump completed on 2016-03-23 19:51:44
