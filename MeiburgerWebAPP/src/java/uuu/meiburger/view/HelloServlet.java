...
public class HelloServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>" + welcome + "," + this.getInitParameter(welcome) + "Servlet HelloServlet at " + request.getContextPath() + "</h1>");            out.println("<p>現在時間" + new Date() + "</p>");
            out.println("</body>");
            out.println("</html>");
        }
    }
